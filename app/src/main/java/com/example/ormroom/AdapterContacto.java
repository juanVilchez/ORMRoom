    ...
    public void onBindViewHolder(ViewHolder holder, final int i) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent = new Intent(micontext, UpdateContact.class);//inicializa update contact
                intent.putExtra(UpdateContact.EXTRA_CONTACT_ID, contact.getPhoneNumber());
                ((MainActivity)micontext).startActivityForResult(intent, 2);// aca hacemos que se liste la vista con el 2
            }
        });
    }
    @Override
